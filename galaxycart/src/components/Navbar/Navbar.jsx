...
const Navbar = () => {
  return (
    <div className="bg-white dark:bg-gray-900 dark:text-whites duration-200 relative z-40">
        <div className="py-4">
            <div className="container flex justify-between items-center">
                ...
                <div className="flex justify-between items-center gap-4">
                    ...
                    <button className="relative p-3">
                        ...
                        <div className="w4 h-4 bg-red-500 text-white rounded-full absolute top-0 right-0 flex items-center justify-center text-xs" >4
